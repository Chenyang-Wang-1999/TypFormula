...
impl<'v, 'e> MathContext<'v, 'e> {
    ...
    fn layout_into_self(
        ...
        let editor_start = self.fragments.len();
        ...
        // Groups are flattened above; retain their source identity afterwards.
...
fn layout_realized(
    ...
    let editor_start = ctx.fragments.len();
    ...
    if !matches!(comp.kind, MathKind::Group(_))
